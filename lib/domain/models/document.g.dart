...
void _scannedDocumentSerialize(
  ...
  writer.writeBool(offsets[4], object.isTrash);
  writer.writeLong(offsets[5], object.sizeInBytes);
...
ScannedDocument _scannedDocumentDeserialize(
  ...
  object.isTrash = reader.readBool(offsets[4]);
  object.sizeInBytes = reader.readLong(offsets[5]);
...
extension ScannedDocumentQuerySortBy
  ...
  QueryBuilder<ScannedDocument, ScannedDocument, QAfterSortBy> sortByIsTrash() {
    return QueryBuilder.apply(this, (query) {
...
extension ScannedDocumentQuerySortThenBy
  ...
  QueryBuilder<ScannedDocument, ScannedDocument, QAfterSortBy> thenByIsTrash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isTrash', Sort.asc);
    });
  }
...
extension ScannedDocumentQueryWhereDistinct
  ...
  QueryBuilder<ScannedDocument, ScannedDocument, QDistinct> distinctByFilePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ScannedDocumentQueryProperty
  ...
  QueryBuilder<ScannedDocument, String, QQueryOperations> filePathProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'filePath');
    });
  }

  QueryBuilder<ScannedDocument, int?, QQueryOperations> folderIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'folderId');
    });
  }

  QueryBuilder<ScannedDocument, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isFavorite');
    });
  }

  QueryBuilder<ScannedDocument, bool, QQueryOperations> isTrashProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isTrash');
    });
  }

  QueryBuilder<ScannedDocument, int, QQueryOperations> sizeInBytesProperty() {
    return QueryBuilder.apply(this, (query) {
